...
Status as of 2026-05-15: this repository is aligned to the expanded `newdata` workbook, the benchmark suite has been rerun on the current data, and the repo now contains a paper-ready record of both the successful and unsuccessful approaches tried so far.
...
`E:\Frames\12 articles Ann. Core Peripheral RST and FrameNET Structure.xlsx`
...
- `poc_outputs/dataset_audit_results.txt`
...
- `poc_outputs/paragraph_umap_cls_core.png`
- `poc_outputs/paragraph_umap_mean_core.png`
- `poc_outputs/token_umap_core.png`
- `poc_outputs/frame_similarity_heatmap.png`
- `poc_outputs/mlm_probing_results.txt`
- `poc_outputs/attention_analysis_results.txt`
...
- `poc_outputs/zero_shot_results.txt`
- `poc_outputs/intra_inter_similarity.png`
- `poc_outputs/frame_taxonomy_heatmap.png`
- `poc_outputs/frame_taxonomy_umap.png`
- `poc_outputs/tokenizer_coverage.png`
...
- `poc_outputs/layerwise_silhouette.png`
- `poc_outputs/knn_probe_results.txt`
- `poc_outputs/sentence_decomposition.txt`
- `poc_outputs/climate_vs_vanilla.png`
- `poc_outputs/gradient_saliency.txt`
...
- `poc_outputs/head_frame_attention.png`
- `poc_outputs/attention_rollout.png`
- `poc_outputs/attention_heatmap_P0.png`
- `poc_outputs/attention_heatmap_P2.png`
- `poc_outputs/attention_heatmap_P15.png`
- `poc_outputs/cross_attention_matrix.png`
- `poc_outputs/attention_entropy.png`
- `poc_outputs/round4_attention_results.txt`
...
- `poc_outputs/setfit_cv_results.txt`
- `poc_outputs/additional_experiments_results.txt`
- `poc_outputs/lora_imbalance_results.txt`
...
- `poc_outputs/additional_core_error_analysis.txt`
...
- `poc_outputs/grouped_calibrated_results.txt`
- `poc_outputs/core_reliability_diagram.png`
- `poc_outputs/core_selective_accuracy.png`
...
- `poc_outputs/core_uncertainty_results.txt`
- `poc_outputs/core_macro_f1_bootstrap.png`
...
- `poc_outputs/token_classification_results.txt`
- `poc_outputs/trigger_threshold_sweep_results.txt`
- `poc_outputs/trigger_structured_decoder_results.txt`
- `poc_outputs/trigger_crf_results.txt`
...
- `poc_outputs/finetune_cv_results.txt`
- `poc_outputs/additional_experiments_results.txt`
- `poc_outputs/peripheral_chain_results.txt`
- `poc_outputs/peripheral_threshold_sweep.png`
- `poc_outputs/peripheral_chain_thresholds.png`
...
```bash
python poc_dataset_audit.py
python poc_base_model_analysis.py
python poc_round2_analysis.py
python poc_round3_analysis.py
python poc_round4_attention.py
python poc_finetune_setfit.py
python poc_setfit_baseline.py
python poc_token_classification.py
python poc_additional_experiments.py
python poc_grouped_calibrated_experiments.py
python poc_core_uncertainty_analysis.py
python poc_lora_imbalance_experiments.py
python poc_peripheral_chain_experiments.py
python poc_trigger_threshold_sweep.py
python poc_trigger_structured_decoder.py
python poc_trigger_crf.py
```

All scripts now default to the expanded workbook through `climate_frames_dataset.py`.
