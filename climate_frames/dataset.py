...
from climate_frames.paths import CURRENT_DATA_DIR, LEGACY_DATA_DIR


DEFAULT_DATA_PATH = Path(
    os.environ.get(
        "CLFRAMES_DATA_PATH",
        str(CURRENT_DATA_DIR / "14 May 2026 12 articles Ann. Core Peripheral RST and FrameNET Structure.xlsx"),
    )
)
LEGACY_DATA_PATH = LEGACY_DATA_DIR / "12 articles Ann. Core Peripheral RST and FrameNET Structure.xlsx"
